...
switch ( $template_name ) {
    ...
    // Added a new hoock for new speaker profile design ag21
    case  ( ( ETN_DEMO_SITE === true ) || ( ETN_DEMO_SITE === false && 'speaker-two' === $template_name ) ) :
        style_two_hook();
            break;
...
/**
 * Speaker style 2 hook call from here ag21
 */
function style_two_hook() {
     ...
     * @see speaker_socials()
     * 
     * Social area commented to show the changes ag21
     * hook is working
     */
    add_action( "etn_speaker_socials_two", "speaker_socials_two", 15 );
